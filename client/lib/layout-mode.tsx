...
const NEBULA_ELIGIBLE_PATHS = [
  ...
  '/discover', '/lists', '/watch-party', '/metrics', '/vault', '/invitations', '/tasks', '/settings', '/themes', '/changelog', '/health',
];
...
const NEBULA_ELIGIBLE_PREFIXES = ['/users/', '/groups/', '/addons/', '/lists/', '/watch-party/'];
