  ...
  try {
    ...
    if (plan.alreadySynced) {
      ...
      if (credentials.providerType === 'nuvio' && credentials.traxAddonEnabled && credentials.traxToken) {
        ...
        ensureTraxHomePlacement(provider, { id: credentials.id }, `vip.slicksync.trax.${credentials.id}:all:slicktrax-continue`)
    ...
    // Nuvio home placement for the SlickTrax row - fire-and-forget, once
