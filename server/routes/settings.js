...
module.exports = ({ prisma, INSTANCE_TYPE, getAccountDek, getDecryptedManifestUrl, getAccountId }) => {
    ...
    try {
      if (INSTANCE_TYPE !== 'public') {
        ...
        const response = {
          ...
          enableHoverPreviewTrailers: (syncCfg && typeof syncCfg === 'object' && typeof syncCfg.enableHoverPreviewTrailers === 'boolean') ? syncCfg.enableHoverPreviewTrailers : true,
      ...
      if (syncCfg && typeof syncCfg === 'object') {
        ...
        const resp = {
          ...
          enableHoverPreviewTrailers: typeof syncCfg.enableHoverPreviewTrailers === 'boolean' ? syncCfg.enableHoverPreviewTrailers : true,
  ...
  router.put('/account-sync', async (req, res) => {
    try {
      const { enabled, frequency, mode, unsafe, safe, webhookUrl, useCustomFields, useCustomNames, notifyOnActivity, notifyOnSync, notifyOnInvite, notifyOnVault, notifyOnAddonHealth, notifyOnBackup, notifyOnProxyHealth, notifyOnMosaic, notifyDigestEnabled, notifyDigestFrequency, accountTimezone, vaultCurrency, enableWatchlist, enableWatchedIndicators, enableRecommendations, enableHoverPreviewTrailers, tmdbApiKey, mdblistApiKey, rpdbApiKey } = req.body || {}
      ...
      if (INSTANCE_TYPE !== 'public') {
        ...
        const nextCfg = {
          ...
          enableHoverPreviewTrailers: enableHoverPreviewTrailers !== undefined ? !!enableHoverPreviewTrailers : (typeof baseCfg.enableHoverPreviewTrailers === 'boolean' ? baseCfg.enableHoverPreviewTrailers : true),
      ...
      if (enableHoverPreviewTrailers !== undefined) partial.enableHoverPreviewTrailers = !!enableHoverPreviewTrailers
