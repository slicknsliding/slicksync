...
print('  curl -X POST https://slicksync.example.com/api/aiometadata/manifest-url \\')
print('    -H "Content-Type: application/json" \\')
print('    -d \'{"manifestUrl":"https://aiometadata.example.com/stremio/REDACTED-INSTANCE-UUID/manifest.json"}\'')
